...
function lvfw_create_woolinkedvariation_cpt() {
	$labels = array(
		...
		'archives'              => esc_html__( 'Woo Linked Variation Archives', 'linked-variation-for-woocommerce' ),
		'attributes'            => esc_html__( 'Woo Linked Variation Attributes', 'linked-variation-for-woocommerce' ),
		'parent_item_colon'     => esc_html__( 'Parent Woo Linked Variation:', 'linked-variation-for-woocommerce' ),
		'all_items'             => esc_html__( 'Woo Linked Variations', 'linked-variation-for-woocommerce' ),
		'add_new_item'          => esc_html__( 'Add New Woo Linked Variation', 'linked-variation-for-woocommerce' ),
		'add_new'               => esc_html__( 'Add New Linked Variation', 'linked-variation-for-woocommerce' ),
		'new_item'              => esc_html__( 'New Woo Linked Variation', 'linked-variation-for-woocommerce' ),
		'edit_item'             => esc_html__( 'Edit Woo Linked Variation', 'linked-variation-for-woocommerce' ),
		'update_item'           => esc_html__( 'Update Woo Linked Variation', 'linked-variation-for-woocommerce' ),
		'view_item'             => esc_html__( 'View Woo Linked Variation', 'linked-variation-for-woocommerce' ),
		'view_items'            => esc_html__( 'View Woo Linked Variations', 'linked-variation-for-woocommerce' ),
		'search_items'          => esc_html__( 'Search Woo Linked Variation', 'linked-variation-for-woocommerce' ),
		...
		'insert_into_item'      => esc_html__( 'Insert into Woo Linked Variation', 'linked-variation-for-woocommerce' ),
		'uploaded_to_this_item' => esc_html__( 'Uploaded to this Woo Linked Variation', 'linked-variation-for-woocommerce' ),
		'items_list'            => esc_html__( 'Woo Linked Variations list', 'linked-variation-for-woocommerce' ),
